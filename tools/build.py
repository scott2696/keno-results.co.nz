...
PAGES = [
    ...
    dict(slug="new-casinos-nz", src="new-casinos-nz",
         ...
         title="New Online Casinos NZ (2026-27) | keno-results.co.nz",
         og="New online casinos in NZ",
         desc="What \u201cnew\u201d will mean in New Zealand once licensing opens in 2027, why "
              "new sites are structurally riskier, and how to judge one with no track record."),
    dict(slug="no-deposit-bonus", src="no-deposit-bonus",
         ...
         title="No Deposit Bonus NZ: What the Cap Really Means | keno-results.co.nz",
         og="No deposit bonuses",
         desc="Why maximum conversion, not bonus size, decides what a no deposit bonus is "
              "worth in NZ \u2014 with a worked example and what the offer actually costs you."),
    dict(slug="crypto-casinos-nz", src="crypto-casinos-nz",
         ...
         title="Crypto Casinos NZ: Two Bets, Not One | keno-results.co.nz",
         og="Crypto casinos for NZ players",
         desc="What provably fair really proves, why \u201cno verification\u201d is the claim to "
              "distrust, the four-conversion round trip, and the NZ tax point nobody mentions."),
